...
/**
 * Controller for the employee dashboard view. Provides a simplified dashboard for employees with
...
public class EmployeeDashboardController {
  ...
  @FXML private Button myProjectsButton;
  ...
  // Stats labels
  @FXML private Label tasksDueTodayLabel;

 ...
 *
 * <ul>
 *   <li>Persists the user's preference using {@link Preferences}.
 *   <li>Keeps the in-memory session preference in sync via {@link SessionManager}.
 *   <li>Applies a root-level stylesheet to enable dark mode across all views.
 * </ul>
 */
public final class ThemeService {
  ...
  private static final String DARK_STYLESHEET_RESOURCE =
      "/com/example/shenanigans/core/theme/dark-mode.css";
  ...
  /**
   * Enables/disables dark mode, persists the preference, and applies it to the current scene.
   *
   ...
   *
   * <p>This attaches/removes the dark-mode stylesheet at the root node level so it can override

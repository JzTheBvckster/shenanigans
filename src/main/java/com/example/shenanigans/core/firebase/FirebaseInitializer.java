...
/**
 * Initializes and manages Firebase services for the application. This is the single entry point for
 * all Firebase operations.
 *
 * <p>Usage: Call {@link #initialize(String)} once at application startup, then use the getter
 * methods to access Firebase services.
 */
public final class FirebaseInitializer {
   ...
   *
   * @param serviceAccountPath Path to the Firebase service account JSON file. Place this file in

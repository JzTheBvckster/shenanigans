 ...
 * Handles client-side authentication operations (sign in, sign up, password
 * reset).
 * 
 * <p>
 * This uses Firebase's Identity Toolkit REST API since the Admin SDK
 * doesn't support client-side email/password authentication.
 * </p>
 * 
...
public class FirebaseAuthClient {
    ...
    private String sendPostRequest(String urlString, String payload) throws IOException, FirebaseAuthException {
    ...
    private FirebaseAuthException parseErrorResponse(String errorResponse, int responseCode) {
        ...
        } else if (errorResponse.contains("INVALID_PASSWORD") || errorResponse.contains("INVALID_LOGIN_CREDENTIALS")) {
